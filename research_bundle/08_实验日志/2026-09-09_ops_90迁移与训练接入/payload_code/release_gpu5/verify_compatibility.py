...
def require_data_output(path):
    ...
    if os.name != 'posix' or Path(os.environ.get('RGBIR90_PROJECT_ROOT', '/mnt/dataX/ydf/projects/RGBT_campaign_90')).resolve() not in resolved.parents:
        raise ValueError('Real compatibility traces must be under the 90 project data-disk root')
