...
REPO_ROOT = Path(os.environ.get('RGBIR90_PROJECT_ROOT', str(Path(__file__).resolve().parents[1])))
DEFAULT_LEASE_FILE = REPO_ROOT / "runs" / ".project_resource_leases.json"  # One pool for all 90 payload releases.
