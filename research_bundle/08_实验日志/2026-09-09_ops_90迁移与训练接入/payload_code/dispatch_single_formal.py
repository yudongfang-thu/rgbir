...
REPO=Path(os.environ.get('RGBIR90_PROJECT_ROOT', '/mnt/dataX/ydf/projects/RGBT_campaign_90'))
PY=os.environ.get('RGBIR90_PYTHON', '/mnt/dataX/ydf/projects/RGBT_campaign_90/environments/rgbir90/bin/python')
...
def run_job(job, output):
    ...
    with log_path.open('x') as log:
        while True:
            ...
            if job['kind']=='train':
                command+=['--formal-train'] if job.get('formal') else ['--non-formal-train']
            command+=['--',*job['command']]
