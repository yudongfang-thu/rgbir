...
class PolicyTests(unittest.TestCase):
    def test_bootstrap_with_graphics_process_is_not_empty(self):
        state = usage()
        g = rows(2)
        g[0]['all_process_pids'] = [42]  # tiny graphics context still counts
        g[1]['memory_used_mib'] = 101  # unexplained memory is not fully empty
