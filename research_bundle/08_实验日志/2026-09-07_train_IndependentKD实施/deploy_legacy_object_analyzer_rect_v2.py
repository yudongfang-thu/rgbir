...
OUT=HERE/'legacy_object_analyzer_deployment_rect_v2'
BASE='/mnt/dataset/yudongfang/projects/RGBT_campaign/artifacts/rgbir_independent_kd_v2_20260907'
REMOTE=BASE+'/legacy_object_analyzer_rect_v2'
PY='/mnt/dataset/yudongfang/projects/SpaceNet6_OTD_official_reproduction/environments/sn6-int8-kd/bin/python'
original=HERE/'object_analyzer_rect_independent_review_v2/review_receipt.json'
...
for row in review['source_files']:
    source=HERE/'object_error_analyzer_rect_v2'/row['relative'];accepted=Path(row['accepted_copy'])
...
archive=HERE/'legacy_object_analyzer_rect_v2_deployment.tar.gz'
