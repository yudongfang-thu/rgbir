...
| 2026-09-08 | [probe_同帧选择覆盖](2026-09-08_probe_同帧选择覆盖/README.md) | probe | 两次零更新推理完成；32图80GT旧候选机会9→原生检出机会1，selected31/32双方已检出；修正低置信解释，下一项复用完整dev缓存 |
| 2026-09-08 | [probe_快速方向筛选](2026-09-08_probe_快速方向筛选/README.md) | probe | 九次分钟级短训与完整dev已完成；分类/定位/置信度/局部特征关系统一读出，微小单seed差不扩E200；保留原F阻塞与F-GM协议修订 |
...
| 2026-09-07 | [train_IndependentKD实施](2026-09-07_train_IndependentKD实施/README.md) | train | 2026-09-08 09:39：C1进行中59/57/58轮、旧控制116/102，健康无新端点；09:29 ETA约44–46小时；快版已有E8实测，专门同负载对照尚未执行 |
