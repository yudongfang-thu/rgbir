...
> 状态：pending；完整端点 3/6。本报告不读取训练CSV中的占位指标。

UTC采集时间：2026-09-06T13:46:12.510719+00:00。主量为同seed paired−weight0 mAP50–95百分点，固定E200 last/EMA与完整开发val。

| student seed | arm | 状态 | mAP50–95 (%) |
|---|---|---|---:|
| 0 | paired | pending_training | — |
| 0 | weight0 | completed | 54.346185 |
| 42 | paired | completed | 54.658162 |
| 42 | weight0 | pending_training | — |
| 123 | paired | completed | 54.636847 |
| 123 | weight0 | pending_training | — |
