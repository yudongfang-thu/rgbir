# 固定 anchor 定位目标平移压力诊断（2026-09-07）
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
|LLVIP|1|61|+0.22546|-0.90463|100.00%|96.72%|100.00%|61/61|
|LLVIP|2|61|+0.18200|-0.85904|98.36%|96.72%|100.00%|61/61|
|LLVIP|4|61|+0.09700|-0.75282|78.69%|90.16%|98.36%|61/61|
|Drone|1|47|+0.16707|-0.59182|97.87%|95.74%|100.00%|47/47|
|Drone|2|47|+0.10067|-0.49204|89.36%|93.62%|95.74%|47/47|
|Drone|4|47|-0.02310|-0.22990|38.30%|72.34%|89.36%|47/47|
...
- [精简逐条件原始表]（服务器/本地中间产物：outputs_attempt1/compact_metrics.csv）、[完整分布统计]（服务器/本地中间产物：outputs_attempt1/all_metrics.csv）、[八方向最差原始表]（服务器/本地中间产物：outputs_attempt1/all_worst_case.csv）。
...
- [CPU真值回执]（服务器/本地中间产物：outputs_attempt1/known_truth_tests.json）：10项通过；64个KD与GT梯度均以中心有限差分核验，另含质量守恒/无clamp/零扰动exact/严格.70/固定mask等。
...
- [完成回执]（服务器/本地中间产物：outputs_attempt1/completion_receipt.json）：`COMPLETED_PENDING_INDEPENDENT_REVIEW`。
