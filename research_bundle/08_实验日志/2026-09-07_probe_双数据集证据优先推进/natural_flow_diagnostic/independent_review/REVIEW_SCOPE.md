...
补充勘误（2026-09-07，保留原冻结措辞）：上文“None/false geometry仅未验证几何上界”应限于未过滤的候选机会集合；它可能改变被选 anchor，不能保证最终 selected_count 为严格上界。最终代码与报告状态统一为 UNVERIFIED_GEOMETRY_DIAGNOSTIC，不支持几何、校准或训练准入。
