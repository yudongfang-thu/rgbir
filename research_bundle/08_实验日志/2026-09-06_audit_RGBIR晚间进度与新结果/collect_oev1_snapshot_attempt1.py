...
OUT = BASE / 'artifacts/audit_rgbir_evening_20260906_1727'
...
for cell in endpoint['cells']:
    ...
    rows = [{k.strip(): v for k,v in r.items()} for r in csv.DictReader(csv_path.read_text().splitlines())] if csv_path.exists() else []
