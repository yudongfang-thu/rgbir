...
exec "$PY" -u "$ROOT/release_v1/campaign_queue.py" --stage canary --gpu 4 --vram-mib 10000 --rss-mib 16384 --root "$ROOT" --run-root "$RUNS" --attempt attempt1 > "$ROOT/canary_attempt1.log" 2>&1
