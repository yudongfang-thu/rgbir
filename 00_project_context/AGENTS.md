...
1. 读 [README.md](README.md)（目录地图）→ [08_实验日志/README.md](../research_bundle/08_实验日志/README.md)（**实验索引，最新条目在最上**）→ 最近 2-3 个实验条目的结论；
2. 需要证据背景时读 [05_实验证据_按服务器/实验证据对照总表.md](../research_bundle/05_实验证据_按服务器/实验证据对照总表.md)；
...
- 90 上的 ogsod400-research-core 等目录属 canonical 链路，动前先对照 [05_实验证据_按服务器/实验证据对照总表.md](../research_bundle/05_实验证据_按服务器/实验证据对照总表.md)。
