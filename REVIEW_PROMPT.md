...
> 本轮先读[LATEST_RESULTS.md](LATEST_RESULTS.md)及21:46/17:30原始证据。请复算OEv1 P42/P123/N0的完整端点，不把跨seed差值当净收益；审查OS-SSL P123−shuffled123的单seedCSV信号、旧native初始化混杂和RGB自模态控制缺口。+0.495 AP50不能舍入过+0.5门。早晨“尚无终点”等状态仅属于旧快照。
